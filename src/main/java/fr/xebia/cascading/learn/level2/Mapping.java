...
public class Mapping {
   ...
   */
  public static FlowDef filterWithExpression(Tap<?, ?, ?> source,
      Tap<?, ?, ?> sink) {
    Pipe pipe = new Pipe("filterWithExpression");
    ExpressionFilter filter = new ExpressionFilter(
        "!line.contains(\"Hadoop\")", String.class);
   ...
   * @see http://docs.cascading.org/cascading/2.1/userguide/html/ch08s07.html
   */
  public static FlowDef transformWithExpression(Tap<?, ?, ?> source,
      Tap<?, ?, ?> sink) {
    Pipe pipe = new Pipe("transformWithExpression");
    ExpressionFunction function = new ExpressionFunction(new Fields("line"),
        "line.toLowerCase()", String.class);
  ...
  public static FlowDef transformWithACustomFunction(Tap<?, ?, ?> source,
    ...
    Pipe pipe = new Each("split", new Fields("line"),
        new CustomSplitFunction<Object>(new Fields("word")), Fields.SWAP);
